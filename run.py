...
if __name__ == '__main__':
    ...
    for name, subcommand in subcommands.items():
        ...
        subparser.add_argument('--model', '-m', default='exp/nmt/codt-bert/model',
                               help='path to model file')
        subparser.add_argument('--vocab', '-v', default='exp/nmt/codt-bert/vocab',
                               help='path to vocab file')
        subparser.add_argument('--config', '-sc', default='exp/nmt/codt-bert/config.ini',
                               help='path to vocab file')
