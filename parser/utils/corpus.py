...
class Corpus(object):
    ...
    @property
    def words(self):
        return [[self.bos] + list(sentence.FORM) for sentence in self]

    @property
    def tags(self):
        return [[self.bos] + list(sentence.CPOS) for sentence in self]
    ...
    @property
    def rels(self):
        return [[self.bos] + list(sentence.DEPREL) for sentence in self]
